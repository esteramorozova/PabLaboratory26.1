...
public class AddressDtoValidator : AbstractValidator<AddressDto>
{
    public AddressDtoValidator()
    {
        ...
        RuleFor(x => x.Country)
            ...
            .MaximumLength(100).WithMessage("Nazwa kraju nie może przekraczać 100 znaków.");

        RuleFor(x => x.Type)
            .IsInEnum().WithMessage("Nieprawidłowy typ adresu (wymagana wartość ze stałych wyliczeniowych).");
    }
}
